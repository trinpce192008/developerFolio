...
const skillsSection = {
  title: "What I do",
  subTitle: "I'm studying at FPTHCM University!",
  skills: [
    emoji(
  ...
  schools: [
    {
      ...
      descBullets: [
        "Looking for an internship position in Information Security.",
        "My dream job involves application policy and user policy."
      ]
    }
    // {
...
const bigProjects = {
  title: "Projects during the learning process",
...
const contactInfo = {
  ...
  number: "+84 337010437",
  email_address: "trinp.ce192008@gmail.com"
};
